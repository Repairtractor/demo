package com.lcc.minispring.beans.factory.xml;
...
import com.lcc.minispring.beans.factory.support.AbstractBeanDefinitionReader;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinitions(Resource resource) throws BeansException {
        try {
            ...
            throw new RuntimeException(StrUtil.format("Failed to load bean class from {}", resource), e);
        }
    }
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException{
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (getRegistry().containsBeanDefinition(beanName)) {
                throw new RuntimeException(StrUtil.format("Duplicate beanName {}", beanName));
            }
