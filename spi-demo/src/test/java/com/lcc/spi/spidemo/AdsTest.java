...
import com.lcc.spi.spidemo.excel.GoogleAdsExcelDTO;
...
//    private static final String DEVELOPER_TOKEN = "C36whFbU6_V289FqCDaP_Q";
    ...
    private static final String OAUTH_CLIENT_ID = "874454012684-01eq26v7mfrde6b6teaislhojbd3u6dt.apps.googleusercontent.com";
    private static final String OAUTH_CLIENT_SECRET = "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";
    private static final String REFRESH_TOKEN = "1//0eo-HrW52GDXdCgYIARAAGA4SNwF-L9IrQQjMIGyVLATluemVHfKyrP9aIHyHW41HGsYtD0PiwD4zQ5s956kIcGxJuNSIusbQS-I";
//    private static final String OPERATING_CUSTOMER_ID = "7545974356";
        private static final String OPERATING_CUSTOMER_ID = "9253991742";
//    private static final String LOGIN_CUSTOMER_ID = "7545974356";
    private static final String LOGIN_CUSTOMER_ID = "9253991742";
...
//        System.setProperty("http.proxyPort", "8118");
    ...
    public void allInfoTest() {
        String query = "SELECT ad_group_ad.ad.final_urls,ad_group_ad.ad.id,campaign.name,compaaign.id,ad_group.name,\n" +
                "ad_group_ad.policy_summary.approval_status,ad_group_ad.id,ad_group_ad.ad.id\n" +
                "ad_group_ad.ad.type,\n" +
                "ad_group_ad.ad.name," +
                "metrics.clicks,\n" +
                "metrics.impressions,\n" +
                "metrics.cost_micros\n" +
                "FROM ad_group_ad\n" +
                "WHERE   segments.date >= '2023-10-01' AND segments.date <= '2023-10-07'\n" +
                "AND ad_group_ad.status != 'REMOVED'";
