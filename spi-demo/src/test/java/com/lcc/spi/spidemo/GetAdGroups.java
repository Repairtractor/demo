...
import com.lcc.spi.spidemo.utill.ArgumentNames;
import com.lcc.spi.spidemo.utill.CodeSampleParams;
...
public class GetAdGroups {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!params.parseArguments(args)) {
            ...
            params.customerId = Long.parseLong("2814642295");

            // Optional: Specify a campaign ID to restrict search to only a given campaign.
            params.campaignId = Long.parseLong("2814642295");
        }
    ...
    private void runExample(
        ...
        try (GoogleAdsServiceClient googleAdsServiceClient =
            ...
            // Iterates over all rows in all pages and prints t
            // \
            // he requested field values for the ad group
            // in each row.
